...
Input: Danh sách books gồm nhiều đối tượng, mỗi đối tượng có id, title, và có thể có quantity.

Output mong muốn: JSON object gồm:

message: thông báo tình trạng dữ liệu.

data: danh sách các sách có quantity <= 5.

Điều kiện xác định sách sắp hết hàng: quantity <= 5, đồng thời bỏ qua sách thiếu trường quantity hoặc có quantity < 0.
"""
